...
<body>
    <div class="sidebar">
        ...
        if ($role == 'admin') {
            ...
            // Customize what to display for employees
        } else {
                        ...
                        <table>
                            <tr>
                                <td style="border: 1px solid;">
                                    ...
                                    <input type="radio" name="educational_background" value="Master's Level" <?php if ($profile['educational_background'] == 'Master\'s Level') echo 'checked'; ?> required> Master's Level<br>
                                    <input type="radio" name="educational_background" value="Master's Graduate" <?php if ($profile['educational_background'] == 'Master\'s Graduate') echo 'checked'; ?> required> Master's Graduate<br>
