...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      href="../bootstrap/../bootstrap/assets/img/kaiadmin/favicon.ico"
      type="image/x-icon"
    />

    <!-- Fonts and icons -->
    <script src="../bootstrap/../bootstrap/assets/js/plugin/webfont/webfont.min.js"></script>
    <script>
      WebFont.load({
        ...
        custom: {
          ...
          urls: ["../bootstrap/../bootstrap/assets/css/fonts.min.css"],
        },
        active: function () {
  ...
  <body>
                        ...
                        while ($row = mysqli_fetch_assoc($sql_result)) {
                            ...
                            <tr>
                                ...
                                <td><center>
                                  ...
                                  <a href="delete_acc.php?id=<?= $row['id']; ?>" class="btn btn-link btn-danger" title="Delete" data-bs-toggle="tooltip"
    ...
    <!-- Kaiadmin JS -->
    <script src="../bootstrap/sassets/js/kaiadmin.min.js"></script>
  </div>
  </div>
</body>
</html>