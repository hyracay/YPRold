              ...
              <tbody> 
                ...
                <td>
                 <a href="#" class="profileNameLink" data-id="
                    ...
                    <?= $row['house_number'] . ', ' . $row['purok'] . ', ' . $row['sitio'] . ' ' . $row['barangay'] . ', ' . $row['municipality'] . ', ' . $row['province'] . ', ' . $row['region']; ?>" data-address="
                    <?= $row['sex']; ?>" data-age="
                    <?= $row['age']; ?>" data-email="
                   ...
                   <div class="form-group form-group-default">
                    ...
                    <div>
                     <select id="birth_month" name="birth_month" required onchange="calculateAge()">
                      <option value="">Month</option> <?php for ($m = 1; $m <= 12; ++$m) { ?> <option value="
                        <?php echo $m; ?>"> <?php echo date('F', mktime(0, 0, 0, $m, 1)); ?> </option> <?php } ?>
                     </select>
                     <select id="birth_day" name="birth_day" required onchange="calculateAge()">
                      <option value="">Day</option> <?php for ($d = 1; $d <= 31; ++$d) { ?> <option value="
                        <?php echo $d; ?>"> <?php echo $d; ?> </option> <?php } ?>
                     </select>
